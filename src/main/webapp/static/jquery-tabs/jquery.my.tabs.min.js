...
// Data : 2012-09-06
// =================================================*/
(function(e){e.fn.Tabs=function(b){return this.each(function(){b=e.extend({event:"mouseover",timeout:0,auto:0,callback:null,switchBtn:false},b);var c=e(this),k=e("div.tab_box").children("div"),l=e("ul.tab_menu"),g=l.find("li"),i,m=function(a){a.siblings("li").removeClass("current").end().addClass("current");k.siblings("div").addClass("hide").end().eq(a.index()).removeClass("hide")},o=function(a,d){d?setTimeout(function(){m(a)},d):m(a)},n=function(){if(b.auto)i=setInterval(j,b.auto)},
