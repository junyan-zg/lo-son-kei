...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/member/memberAccount/">会员资金流动列表</a></li>
		<li class="active"><a href="${ctx}/member/memberAccount/form?id=${memberAccount.id}">会员资金流动<shiro:hasPermission name="member:memberAccount:edit">${not empty memberAccount.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="member:memberAccount:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="memberAccount" action="${ctx}/member/memberAccount/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">流动类型：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">资金变化数目：</label>
			<div class="controls">
